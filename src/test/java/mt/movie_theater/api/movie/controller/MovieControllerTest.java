...
class MovieControllerTest {
    ...
    @DisplayName("신규 영화를 이미지 파일과 함께 등록한다.")
    @Test
    void createMovieWithFile() throws Exception {
        //given
    ...
    @DisplayName("신규 영화를 이미지 파일 URL 과 함께 등록한다.")
    @Test
    void createMovieWithUrl() throws Exception {
        //when, then
        mockMvc.perform(MockMvcRequestBuilders.multipart("/api/v1/movies/new")
                        .param("title", "청설")
                        .param("subTitle", "Hear Me: Our Summer")
                        ...
                        .param("releaseDate", "2024.10.27")
                        .param("durationMinutes", "108")
                        .param("posterImageUrl", "test@test.com")
                        .param("ageRating", "ALL")
                        .param("director", "조선호")
                        .param("screeningType", "TWO_D")
                        .param("standardPrice", "10000")
    ...
    @Test
    void createMovieWithNoMovieWithFileTitle() throws Exception {
        //given
        MockMultipartFile file = new MockMultipartFile(
                "posterImage", // 필드 이름
                "test.txt", // 원래 파일 이름
